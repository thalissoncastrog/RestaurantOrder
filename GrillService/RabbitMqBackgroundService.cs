    ...
    public class RabbitMqBackgroundService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            return Task.Run(() => {
                ...
                channel.QueueDeclare(queue: "grill", durable: false, exclusive: false, autoDelete: false, arguments: null);
                ...
                channel.BasicConsume(queue: "grill", autoAck: true, consumer: consumer);
