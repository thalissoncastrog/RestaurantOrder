    ...
    public class RabbitMqBackgroundService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            return Task.Run(() => {
                ...
                channel.QueueDeclare(queue: "salad", durable: false, exclusive: false, autoDelete: false, arguments: null);
                ...
                channel.BasicConsume(queue: "salad", autoAck: true, consumer: consumer);
