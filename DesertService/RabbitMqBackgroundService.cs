    ...
    public class RabbitMqBackgroundService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            return Task.Run(() => {
                ...
                channel.QueueDeclare(queue: "desert", durable: false, exclusive: false, autoDelete: false, arguments: null);
                ...
                channel.BasicConsume(queue: "desert", autoAck: true, consumer: consumer);
